...
- Created a function for finding if an array has any duplicate videos
- Created a function for finding the length of the last word of a string
- Started working on a Pomodoro timer app